...
ENABLE_VOICE = True  # Enable text-to-speech voice output
VOICE_NAME = "Samantha"  # macOS voice (Samantha, Alex, Victoria, etc.)
VOICE_RATE = 180  # Speech rate in words per minute

# Vision verification settings
VERIFY_ACTIONS = True  # Enable vision-based verification after actions
VERIFICATION_TIMEOUT = 2  # Seconds to wait before verifying action
